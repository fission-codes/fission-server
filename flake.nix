{
  ...
  outputs = { self, nixpkgs, flake-utils, rust-overlay, command-utils, }@inputs:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        command_menu = command-utils.commands.${system} {
          db-start = cmd "Start the postgres database"
            ''${pgctl} -o "-k /tmp" -D "./.pg" -l postgres.log start'';

          db-stop = cmd "Stop the postgres database"
      ...
      in rec {
        ...
        packages.default = rustPlatform.buildRustPackage {
          ...
          cargoLock = {
            ...
            outputHashes = {
              "rexpect-0.5.0" =
                "sha256-njjXt4pbLV3Z/ZkBzmBxcwDSqpbOttIpdg+kHND1vSo=";
              "rs-ucan-0.1.0" =
                "sha256-HSxIzqPECJ9KbPYU0aitjxpCf0CSDAv7su1PGxZlpHc=";
            };
          };
