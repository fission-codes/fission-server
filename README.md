<div align="center">
  <a href="https://github.com/icidasset/fission-server" target="_blank">
    <img src="https://raw.githubusercontent.com/icidasset/fission-server/main/assets/a_logo.png" alt="fission-server Logo" width="100"></img>
  </a>
  ...
  <p>
    ...
    <a href="https://codecov.io/gh/icidasset/fission-server">
      <img src="https://codecov.io/gh/icidasset/fission-server/branch/main/graph/badge.svg?token=SOMETOKEN" alt="Code Coverage"/>
    </a>
    <a href="https://github.com/icidasset/fission-server/actions?query=">
      <img src="https://github.com/icidasset/fission-server/actions/workflows/tests_and_checks.yml/badge.svg" alt="Build Status">
    </a>
    <a href="https://github.com/icidasset/fission-server/blob/main/LICENSE-APACHE">
      <img src="https://img.shields.io/badge/License-Apache%202.0-blue.svg" alt="License-Apache">
    </a>
    <a href="https://github.com/icidasset/fission-server/blob/main/LICENSE-MIT">
...
- [Running fission-server on Docker](#running-fission-server-on-docker)
...
## Running fission-server on Docker
...
- Build a multi-plaform Docker image via [buildx][buildx]:
  ...
  ```console
  docker buildx build --platform=linux/amd64,linux/arm64 -t fission-server --progress=plain .
  ```

- Run a Docker image (depending on your platform):

  ```console
  docker run --platform=linux/amd64 -t fission-server
  ```
